    ...
    return ( 
        <>
            ...
            <div className="container" ref={contentRef}>
                <span>Se ha validado su solicitud para Configuración de Perfil, se informa
                    que se ha realizado
                ...
                <br />
                <p>3. Se realiza configuración de Paquete Office 365.</p>
                <br />
                <p>4. Se realiza configuración de impresora.</p>
                <br />
                <p>5. Configuración de ADOBE.</p>
                <br />
                <p>6. Configuración de IZarc.</p>
                <br />
                <p>7. Se procede con el cierre del ticket a satisfacción.</p>
                <br />
